      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-3xl border border-nivo-gold/25 bg-[#0a1020] p-7 shadow-[0_30px_80px_rgba(0,0,0,0.55)]"
          >
            <div className="pointer-events-none absolute -top-20 right-0 h-40 w-40 rounded-full bg-nivo-teal/15 blur-3xl" />
            ...
            <h2 id="coming-soon-title" className="mt-3 font-serif text-3xl text-[#f4f7ff]">
              {BRAND.name} is not live yet.
            </h2>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <a
                ...
                className="btn-primary inline-flex flex-1 items-center justify-center rounded-full px-4 py-3 text-xs font-medium tracking-[0.18em]"
              >
                Follow on X
              </a>
              <a
